...
class ExitScreen:
	...
	def draw_buttons(self):
		...
		pa_txt_rect = pa_txt.get_rect(center = (self.pa_btn_rect.width // 2, self.pa_btn_rect.height // 2))
		...
		q_txt_rect = q_txt.get_rect(center = (self.q_btn_rect.width // 2, self.q_btn_rect.height // 2))
