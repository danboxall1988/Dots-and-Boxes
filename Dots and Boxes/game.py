...
class Board:
	...
	def draw_scores(self):
		""" Blit each players score to the screen """
	...
	def update(self, line, color):
		""" Updates the list of lines that have been drawn """
...
class Highlight:
	...
	def deactivate(self):
		""" When a line is drawn, this deactivates it so that it
			no longer gets highlighted when hovered above
		"""
		self._active = False
...
class Game:
	...
	def setup_highlights_and_line_grids(self):
		""" Populates two multidimensional arrays, one for horizontal 
			both used for lines and one for vertical. These arrays
			are used for highlighting lines that are hovered over
		"""
